...
- **架构**: x86_64 (q35芯片组)
- **NUMA节点**: 2个
- **CPU**: 4核 (每NUMA节点2核: cpus 0-1 在 node 0, cpus 2-3 在 node 1)
- **内存**: 2GB (每NUMA节点1GB)
...
```
Node 0: CPUs 0-1, Memory 1G
Node 1: CPUs 2-3, Memory 1G
Total:   CPUs 0-3, Memory 2GB
```
...
- `/home/sisyphus/code/test/test_result.txt` - 测试结果
